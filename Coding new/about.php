            ...
            <div class="post-content">
                <div class="first-about-post-preview">
                    <p class="preview-text">
                        The thought of moving to another country is a fantasy many of us have entertained, even if only briefly after a particularly great holiday. Returning to the grind of your 9-5 back home 
                        (for me, that’s the UK) just seems dull in comparison to where you’ve been. Then there's that one acquaintance with the jealousy-inducing story of how they lived abroad and “found themselves” 
                        (I put that in quotes because I’m still not sure what that means!). But <strong>how</strong> do you actually move abroad? While many Brits consider Australia, what about our neighbor across the 
                        North Sea <strong>~the Netherlands~</strong> which feels just out of reach after Brexit? That’s where I come in.
                    </p>
                </div>

                <div class="about-me-image">
                    <img src="../Styling/About-page-photo.jpg" alt="about-me-image">
                </div>
            </div>

            <div class="second-about-post-preview">
                <p class="preview-text">
                    Hi, I’m <strong>Poppy</strong>, a Brit who moved to the Netherlands in July 2024. I want to share everything I’ve learned as an expat here, to save you the research I had to do myself—and maybe help others affected by 
                    Brexit achieve their dream of moving abroad. My story starts during the Covid-19 lockdown with Discord (yes, slightly embarrassing). I had just graduated from university, ended a long-term relationship,
                    ...
                    in the lab instead of analysing samples). After six months, Jeroen flew to the UK to meet me in person, and it felt like we had known each other for years. Since then, we’ve been dating long-distance, 
