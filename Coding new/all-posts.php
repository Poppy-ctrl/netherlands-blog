...
$allpostsRows = postingAllPosts($conn);
?>
...
<body class="all-posts-page"> <!-- Add a class to identify the page -->
    ...
    <div class="content clearfix">
        <div class="main-content">
            ...
            <div id="all-posts-list" class="all-posts-list">
            <?php echo $allpostsRows; ?>
            </div>
        </div>
    </div>
